...
// Printer revision
#define PRINTER_TYPE PRINTER_MK3S_Bear
#define PRINTER_NAME PRINTER_MK3S_Bear_NAME
#define PRINTER_MMU_TYPE PRINTER_MK3S_Bear_MMU2
#define PRINTER_MMU_NAME PRINTER_MK3S_Bear_MMU2_NAME
